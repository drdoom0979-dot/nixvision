...
#[allow(dead_code)]
pub static FEATURES: [&str; 3] = ["THREADING", "WASM", "WASM_BINDGEN"];
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub static FEATURES_STR: &str = "THREADING, WASM, WASM_BINDGEN";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The features as above, as lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE: [&str; 3] = ["threading", "wasm", "wasm_bindgen"];
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The feature-string as above, from lowercase strings."#]
#[allow(dead_code)]
pub static FEATURES_LOWERCASE_STR: &str = "threading, wasm, wasm_bindgen";
#[allow(clippy::needless_raw_string_hashes)]
